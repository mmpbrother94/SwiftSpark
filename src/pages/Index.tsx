...
import { BookOpen, BookOpenCheck, Building2, GraduationCap, BarChart, Users } from 'lucide-react';
...
const Index: React.FC = () => {
  ...
  return (
    <MainLayout>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-edu-primary to-edu-secondary text-white py-20">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg text-center animate-slide-up">
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center animate-slide-up" style={{ animationDelay: '100ms' }}>
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center animate-slide-up" style={{ animationDelay: '200ms' }}>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-4xl font-bold text-edu-primary mb-2">50+</div>
              <p className="text-gray-600">Faculty Members</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-edu-primary mb-2">120+</div>
              <p className="text-gray-600">Courses</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-edu-primary mb-2">95%</div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-edu-secondary to-edu-primary text-white">
